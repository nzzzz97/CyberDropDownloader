...
class TheFappeningBlogCrawler(Crawler):
    def __init__(self, manager: Manager):
        super().__init__(manager, "thefappeningblog", "TheFappeningBlog")
        self.primary_base_domain = URL("https://thefappeningblog.com/")
    ...
    async def fetch(self, scrape_item: ScrapeItem) -> None:
        ...
        if not self.logged_in:
            ...
            session_cookie = self.manager.config_manager.authentication_data['Forums']['thefappeningblog_xf_user_cookie']
            username = self.manager.config_manager.authentication_data['Forums']['thefappeningblog_username']
            password = self.manager.config_manager.authentication_data['Forums']['thefappeningblog_password']
            wait_time = 5
        ...
        if self.logged_in:
            ...
            await log("TheFappeningBlog login failed. Skipping.", 40)
    ...
    async def links(self, scrape_item: ScrapeItem, post_content: Tag) -> None:
        ...
        for link_obj in links:
            ...
            if test_for_img and "thefappeningblog.com" not in link:
                continue
